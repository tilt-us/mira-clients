...
readonly linuxdeploy_url="https://github.com/tauri-apps/binary-releases/releases/download/linuxdeploy/linuxdeploy-x86_64.AppImage"
readonly linuxdeploy_sha256="e762bea85c8eb0d4b3508d46e5c1f037f717d0f9303ae3b4aafc8b04991fa1ef"
...
linuxdeploy_path="${tauri_tools_path}/linuxdeploy-x86_64.AppImage"
runtime_path="${MIRA_APPIMAGE_RUNTIME_PATH:-${HOME}/.cache/mira-appimage/runtime-x86_64}"

# tauri-bundler 2.9 downloads these before it invokes linuxdeploy. Supplying
# them here prevents transient GitHub disconnects from failing Linux bundles.
download_verified "${app_run_url}" "${app_run_sha256}" "${app_run_path}"
download_verified "${linuxdeploy_url}" "${linuxdeploy_sha256}" "${linuxdeploy_path}"
