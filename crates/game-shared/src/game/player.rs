...
/// Default health regenerated by a player each second.
pub const DEFAULT_PLAYER_HEALTH_REGENERATION_PER_SECOND: f32 = 1.5;
...
mod tests {
    ...
    #[test]
    fn default_player_health_regeneration_is_one_point_five_per_second() {
        assert_eq!(DEFAULT_PLAYER_HEALTH_REGENERATION_PER_SECOND, 1.5);
    }
}
