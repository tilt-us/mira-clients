...
export type MatchAbortResponse = {
    removed?: boolean;
    cancelledMatch?: _8083ApiMatchResponse;
};

export type _8083ApiMatchResponse = {
    matchId?: string;
    mode?: string;
    status?: 'WAITING_FOR_LOBBIES' | 'PENDING_ACCEPTANCE' | 'CHAMPION_SELECTION' | 'READY' | 'CANCELLED' | 'ENDED';
...
export type _8083ApiChampionHoverRequest = {
    playerPublicId: number;
    champion: string;
};

export type _8083ApiMatchChampionHoversResponse = {
    matchId?: string;
...
export type HoverChampionDuplicateData = {
    body: _8083ApiChampionHoverRequest;
    path: {
        matchId: string;
    };
    query?: never;
...
export type HoverChampionDuplicateResponses = {
     ...
     * OK
     */
    200: _8083ApiMatchChampionHoversResponse;
};
...
export type TemporaryMatchesResponses = {
     ...
     * OK
     */
    200: Array<_8083ApiMatchResponse>;
};
