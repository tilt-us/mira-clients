...
export type ClientOptions = {
    baseUrl: 'http://api.tilt-us.com' | (string & {});
};
...
export type MatchSearchResponse = {
    status?: 'WAITING_FOR_LOBBIES' | 'PENDING_ACCEPTANCE' | 'CHAMPION_SELECTION' | 'READY' | 'CANCELLED' | 'ENDED';
    match?: ApiTiltUsComApiMatchResponse;
};
...
export type MatchAbortResponse = {
    removed?: boolean;
    cancelledMatch?: ApiTiltUsComApiMatchResponse;
};

export type ApiTiltUsComApiMatchResponse = {
    matchId?: string;
    mode?: string;
    status?: 'WAITING_FOR_LOBBIES' | 'PENDING_ACCEPTANCE' | 'CHAMPION_SELECTION' | 'READY' | 'CANCELLED' | 'ENDED';
...
export type ApiTiltUsComApiChampionHoverRequest = {
    playerPublicId: number;
    champion: string;
};

export type ApiTiltUsComApiMatchChampionHoversResponse = {
    matchId?: string;
...
export type EndMatchDuplicateResponses = {
     ...
     * OK
     */
    200: ApiTiltUsComApiMatchResponse;
};
...
export type HoverChampionDuplicateData = {
    body: ApiTiltUsComApiChampionHoverRequest;
    path: {
        matchId: string;
    };
    query?: never;
...
export type HoverChampionDuplicateResponses = {
     ...
     * OK
     */
    200: ApiTiltUsComApiMatchChampionHoversResponse;
};
...
export type TemporaryMatchesResponses = {
     ...
     * OK
     */
    200: Array<ApiTiltUsComApiMatchResponse>;
};
